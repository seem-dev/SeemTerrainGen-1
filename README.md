...
Simply copy everything from this repository in src into Studio. Don't forget the folders and take care of the script-type!
This is how it should look like:

<img width="318" height="219" alt="image" src="https://github.com/user-attachments/assets/f0102bb9-6a83-4a08-8e32-f9dddac8b00d" />
...
In this folder you will create the configs for SeemTerrainGen-1. You can find snippets and examples in this repository (src/examples).
